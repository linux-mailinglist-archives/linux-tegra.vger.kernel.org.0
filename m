Return-Path: <linux-tegra+bounces-12492-lists+linux-tegra=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-tegra@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id eGJ6GXR0qGl6ugAAu9opvQ
	(envelope-from <linux-tegra+bounces-12492-lists+linux-tegra=lfdr.de@vger.kernel.org>)
	for <lists+linux-tegra@lfdr.de>; Wed, 04 Mar 2026 19:05:40 +0100
X-Original-To: lists+linux-tegra@lfdr.de
Received: from sto.lore.kernel.org (sto.lore.kernel.org [IPv6:2600:3c09:e001:a7::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id 09FD4205B59
	for <lists+linux-tegra@lfdr.de>; Wed, 04 Mar 2026 19:05:39 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sto.lore.kernel.org (Postfix) with ESMTP id 9DBF83079C5A
	for <lists+linux-tegra@lfdr.de>; Wed,  4 Mar 2026 18:02:53 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 013483E51E3;
...
X-Spamd-Result: default: False [2.84 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	TAGGED_FROM(0.00)[bounces-12492-lists,linux-tegra=lfdr.de];
	URIBL_MULTI_FAIL(0.00)[kwiboo.se:server fail,ffwll.ch:server fail,pengutronix.de:server fail,ideasonboard.com:server fail,bootlin.com:server fail,tuxon.dev:server fail,linaro.org:server fail,nxp.com:server fail,microchip.com:server fail,glider.be:server fail,sto.lore.kernel.org:server fail,baylibre.com:server fail,intel.com:server fail,suse.de:server fail,rock-chips.com:server fail];
