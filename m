Return-Path: <linux-tegra+bounces-12858-lists+linux-tegra=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-tegra@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id SCdkIlTguWk7PAIAu9opvQ
	(envelope-from <linux-tegra+bounces-12858-lists+linux-tegra=lfdr.de@vger.kernel.org>)
	for <lists+linux-tegra@lfdr.de>; Wed, 18 Mar 2026 00:14:28 +0100
X-Original-To: lists+linux-tegra@lfdr.de
Received: from tor.lore.kernel.org (tor.lore.kernel.org [172.105.105.114])
	by mail.lfdr.de (Postfix) with ESMTPS id 047BC2B3FE0
	for <lists+linux-tegra@lfdr.de>; Wed, 18 Mar 2026 00:14:27 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by tor.lore.kernel.org (Postfix) with ESMTP id 9283A30AB6F2
	for <lists+linux-tegra@lfdr.de>; Tue, 17 Mar 2026 23:09:30 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id E6B744035AD;
...
X-Spamd-Result: default: False [2.84 / 15.00];
	...
	MIME_TRACE(0.00)[0:+];
	TAGGED_FROM(0.00)[bounces-12858-lists,linux-tegra=lfdr.de];
	...
	TAGGED_RCPT(0.00)[linux-tegra,renesas,netdev,kernel];
	NEURAL_HAM(-0.00)[-1.000];
	ASN(0.00)[asn:63949, ipnet:172.105.96.0/20, country:SG];
	DBL_BLOCKED_OPENRESOLVER(0.00)[nxp.com:dkim,nxp.com:email,nxp.com:mid,tor.lore.kernel.org:helo,tor.lore.kernel.org:rdns,glider.be:email,renesas.com:email,armlinux.org.uk:email,davemloft.net:email,lunn.ch:email]
X-Rspamd-Queue-Id: 047BC2B3FE0
