...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id E236E60C213
	for <lists+linux-tegra@lfdr.de>; Tue, 25 Oct 2022 05:09:12 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229588AbiJYDJJ (ORCPT <rfc822;lists+linux-tegra@lfdr.de>);
        Mon, 24 Oct 2022 23:09:09 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:45998 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230434AbiJYDJH (ORCPT
        <rfc822;linux-tegra@vger.kernel.org>);
        Mon, 24 Oct 2022 23:09:07 -0400
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 1919987FA7;
        Mon, 24 Oct 2022 20:09:01 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1666667342; x=1698203342;
  h=date:from:to:cc:subject:message-id:references:
   mime-version:in-reply-to;
  bh=tatYh8M6OuAYGose7IU+eYXG2qpyT8nUwrMb0wgQIBE=;
  b=O6sq4e7eSJP7IOv6NdIET+XXjTZanLdB5/KRQJwtoOwUQ7qFGQ3D4+7R
   CKCyrrNErheTGBs5bLYNfsbhZ7yboni3ETSkZa/IenX9YBOIGCUMJ0dFZ
   PfaHI2B+2c3t99QeYxcdIuCK9rj7Tc3uMxN4ErdUyymknz49iDSIYGEuP
   ASkoAPvzTLDFTx99gWIUW1TovMH/T8AgrqpBwgd7DBmxfCFUbAku/sAwv
   cjdhhvJ6v4KqQOLrg6ICuU8vmIoI+eh+v6X9gVUAgkVYoF6a9dYdpRT6H
   laXOsyg0gkT+C/Iu5WYVoEIfoKgYNo+ZGlDLWGtetTbbxBccQyKCIQRof
   g==;
X-IronPort-AV: E=McAfee;i="6500,9779,10510"; a="393890656"
X-IronPort-AV: E=Sophos;i="5.95,210,1661842800"; 
   d="scan'208";a="393890656"
Received: from orsmga001.jf.intel.com ([10.7.209.18])
  by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 24 Oct 2022 20:09:00 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10510"; a="664762741"
X-IronPort-AV: E=Sophos;i="5.95,210,1661842800"; 
   d="scan'208";a="664762741"
Received: from lkp-server02.sh.intel.com (HELO b6d29c1a0365) ([10.239.97.151])
  by orsmga001.jf.intel.com with ESMTP; 24 Oct 2022 20:08:57 -0700
Received: from kbuild by b6d29c1a0365 with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1onAJF-0005rE-0M;
        Tue, 25 Oct 2022 03:08:57 +0000
Date:   Tue, 25 Oct 2022 11:08:02 +0800
...
Message-ID: <202210251051.Kiscnmbe-lkp@intel.com>
References: <20221024121439.3381239-2-pdeschrijver@nvidia.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="FayllscMmU+9YSWL"
...
[also build test ERROR on clk/clk-next tegra-drm/drm/tegra/for-next linus/master v6.1-rc2 next-20221024]
...
config: arm64-randconfig-r023-20221023
...
>> drivers/clk/tegra/clk-bpmp.c:532:4: error: incompatible integer to pointer conversion passing 'int' to parameter of type 'const char *' [-Wint-conversion]
   ...
   include/linux/dev_printk.h:110:16: note: expanded from macro 'dev_printk_index_wrap'
                   _p_func(dev, fmt, ##__VA_ARGS__);                       \
                                ^~~
   include/linux/dev_printk.h:52:54: note: passing argument to parameter 'fmt' here
   void _dev_warn(const struct device *dev, const char *fmt, ...);
                                                        ^
   1 error generated.


vim +532 drivers/clk/tegra/clk-bpmp.c
