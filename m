...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 027E34B3057
	for <lists+linux-tegra@lfdr.de>; Fri, 11 Feb 2022 23:23:55 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1354051AbiBKWXz (ORCPT <rfc822;lists+linux-tegra@lfdr.de>);
        Fri, 11 Feb 2022 17:23:55 -0500
Received: from mxb-00190b01.gslb.pphosted.com ([23.128.96.19]:58584 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S234605AbiBKWXy (ORCPT
        <rfc822;linux-tegra@vger.kernel.org>);
        Fri, 11 Feb 2022 17:23:54 -0500
Received: from mail-ed1-x52e.google.com (mail-ed1-x52e.google.com [IPv6:2a00:1450:4864:20::52e])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 42A36D48;
        Fri, 11 Feb 2022 14:23:50 -0800 (PST)
Received: by mail-ed1-x52e.google.com with SMTP id g7so2487706edb.5;
        Fri, 11 Feb 2022 14:23:50 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20210112;
        h=message-id:date:mime-version:user-agent:content-language:to:cc
         :references:from:subject:in-reply-to:content-transfer-encoding;
        bh=4hFia4/CgNP2V49sMgESUWCZI66DAOBpfCmtGFpk5Eo=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=4hFia4/CgNP2V49sMgESUWCZI66DAOBpfCmtGFpk5Eo=;
        b=
X-Gm-Message-State: AOAM530m+qO047xOFdBxdGMXpaGpxn0EFcJCZ2KCL3N507T6c7Mdh2bp
        Q6cUZFkWmcq1f87g1f1EZxY=
X-Google-Smtp-Source: ABdhPJwcUenJxNJSPpndlj9Gt4GDZ+v8fE3RcJ02k8e7gp+L5v3Wv2DNX0wkoJIJpRNu4LxPGFlmOQ==
X-Received: by 2002:a05:6402:348b:: with SMTP id v11mr4086417edc.58.1644618228540;
        Fri, 11 Feb 2022 14:23:48 -0800 (PST)
Received: from ?IPV6:2003:ea:8f4d:2b00:e4fc:b19a:b6f3:47f? (p200300ea8f4d2b00e4fcb19ab6f3047f.dip0.t-ipconnect.de. [2003:ea:8f4d:2b00:e4fc:b19a:b6f3:47f])
        by smtp.googlemail.com with ESMTPSA id z10sm747337ejl.110.2022.02.11.14.23.47
        (version=TLS1_3 cipher=TLS_AES_128_GCM_SHA256 bits=128/128);
        Fri, 11 Feb 2022 14:23:47 -0800 (PST)
Message-ID: <53537800-d01f-bed2-a776-bdbfd2d3f5f7@gmail.com>
Date:   Fri, 11 Feb 2022 23:23:44 +0100
MIME-Version: 1.0
...
References: <YgY7LW8WLtTCZUu0@Red>
 <1e89db6c-f992-e748-0b97-461e23f3c25f@gmail.com> <YgbBGm/STwCfuFGM@Red>
From:   Heiner Kallweit <hkallweit1@gmail.com>
Subject: Re: NETDEV WATCHDOG: enp1s0 (r8169): transmit queue 0 timed out
In-Reply-To: <YgbBGm/STwCfuFGM@Red>
...
On 11.02.2022 21:03, Corentin Labbe wrote:
...
OK, so it's a RTL8168g. There was a time about kernel 5.8/5.9 when the same issue with RTL8168g
occurred on x86. For an unknown reason the issue was gone with 5.10. RTL8168g being affected only
makes me think that some chip hw issue might contribute to the problem.
For quite some time I haven't seen this issue being reported on x86, this might indicate that
the issue is platform-dependent. You're one of the few users with a system using RTL8168 on ARM.
Another potential root cause could be an issue with the respective PCIe sw or hw.

As a last resort you could switch to the r8168 vendor driver. At least for some affected x86 users
this helped. The vendor driver includes quite some undocumented magic, part of it may work around
