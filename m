...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 9357D9A037
	for <lists+linux-tegra@lfdr.de>; Thu, 22 Aug 2019 21:39:58 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2391971AbfHVTjo (ORCPT <rfc822;lists+linux-tegra@lfdr.de>);
        Thu, 22 Aug 2019 15:39:44 -0400
Received: from bombadil.infradead.org ([198.137.202.133]:59244 "EHLO
        bombadil.infradead.org" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S2391721AbfHVTjn (ORCPT
...
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
        ...
        bh=K/K87LD+owFWABp0cQUxkj217i2yiKPfRQ3HA8bjAMU=; b=dyzsnwpj++fbEyfPL4xcNMR0KP
        ;
Received: from [177.133.63.56] (helo=bombadil.infradead.org)
        by bombadil.infradead.org with esmtpsa (Exim 4.92 #3 (Red Hat Linux))
        id 1i0svr-0002lZ-IE; Thu, 22 Aug 2019 19:39:41 +0000
Received: from mchehab by bombadil.infradead.org with local (Exim 4.92)
        (envelope-from <mchehab@bombadil.infradead.org>)
        id 1i0svo-0007IW-HI; Thu, 22 Aug 2019 16:39:36 -0300
...
Subject: [PATCH 5/7] media: use the BIT() macro
Date:   Thu, 22 Aug 2019 16:39:32 -0300
Message-Id: <c98344166a27f771db7f6379378080b04c06c814.1566502743.git.mchehab+samsung@kernel.org>
...
index 67a80e42b5c7..f9e9f8cc9573 100644
...
+#define MANTIS_I2C_RATE_2		BIT(6)
...
index d88cc02d01d3..6053aa3c64a4 100644
...
+#define	  SOLO_BAUDRATE_115200			((0<<9)|BIT(6))
...
+#define	  SOLO_BAUDRATE_2400			(BIT(9)|(6<<6))
...
index 4a0ed29723e8..b459243799f7 100644
...
+#define VPFE_SYN_MODE_15BITS			BIT(8)
...
index 3ae301320313..f4f6022fe757 100644
...
+#define CCDC_SYN_MODE_15BITS			BIT(8)
...
index 48f2cf1148b8..88c013d425a5 100644
...
+#define FLITE_REG_CISRCSIZE_ORDER422_IN_YCRYCB	BIT(14)
...
+#define FLITE_REG_CIIMGCPT_CPT_MOD_FRCNT	BIT(18)
...
+#define FLITE_REG_CIODMAFMT_YCRYCB		BIT(4)
...
index 03ba6c2bc84b..df6360137b81 100644
...
+#define FIMC_REG_CISRCFMT_ORDER422_YCRYCB	BIT(14)
...
+#define FIMC_REG_CIGCTRL_TESTPAT_COLOR_BAR	BIT(27)
...
+#define FIMC_REG_CITRGFMT_YCBCR422		BIT(29)
...
+#define FIMC_REG_CITRGFMT_FLIP_X_MIRROR		BIT(14)
...
+#define FIMC_REG_CIOCTRL_ORDER422_YCRYCB	BIT(0)
...
+#define FIMC_REG_CIOCTRL_YCBCR_2PLANE		BIT(3)
+#define FIMC_REG_CIOCTRL_YCBCR_PLANE_MASK	BIT(3)
...
+#define FIMC_REG_CIOCTRL_ARGB1555		BIT(16)
...
+#define FIMC_REG_CISCCTRL_INRGB_FMT_RGB666	BIT(13)
...
+#define FIMC_REG_CISCCTRL_OUTRGB_FMT_RGB666	BIT(11)
...
+#define FIMC_REG_CIIMGEFF_IE_SC_AFTER		BIT(29)
 #define FIMC_REG_CIIMGEFF_FIN_BYPASS		(0 << 26)
-#define FIMC_REG_CIIMGEFF_FIN_ARBITRARY		(1 << 26)
+#define FIMC_REG_CIIMGEFF_FIN_ARBITRARY		BIT(26)
...
+#define FIMC_REG_MSCTRL_C_INT_IN_2PLANE		BIT(15)
+#define FIMC_REG_MSCTRL_C_INT_IN_MASK		BIT(15)
...
+#define FIMC_REG_MSCTRL_FLIP_X_MIRROR		BIT(13)
...
+#define FIMC_REG_MSCTRL_ORDER422_YCRYCB		BIT(4)
...
+#define FIMC_REG_MSCTRL_INFORMAT_YCBCR422	BIT(1)
...
index 29f839cdb486..f3158ca82eb4 100644
...
+#define  CISRCFMT_ORDER422_YCRYCB		BIT(14)
...
+#define  CIGCTRL_TESTPATTERN_COLOR_BAR		BIT(27)
...
+#define  CITRGFMT_OUTFORMAT_YCBCR422		BIT(29) /* only for s3c6410 */
...
+#define  CITRGFMT_FLIP_X_MIRROR			BIT(14)
...
+#define  CISCCTRL_INRGB_FMT_RGB666		BIT(13)
...
+#define  CISCCTRL_OUTRGB_FMT_RGB666		BIT(11)
...
+#define  CIIMGEFF_FIN_ARBITRARY			BIT(26)
...
+#define  MSCTRL_ORDER422_M_YCRYCB		BIT(4)
...
+#define  MSCTRL_INFORMAT_M_YCBCR422		BIT(1)
