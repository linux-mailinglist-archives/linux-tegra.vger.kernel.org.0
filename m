Return-Path: <linux-tegra+bounces-12635-lists+linux-tegra=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-tegra@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id gN0uKPBjrWkG2QEAu9opvQ
	(envelope-from <linux-tegra+bounces-12635-lists+linux-tegra=lfdr.de@vger.kernel.org>)
	for <lists+linux-tegra@lfdr.de>; Sun, 08 Mar 2026 12:56:32 +0100
X-Original-To: lists+linux-tegra@lfdr.de
Received: from sto.lore.kernel.org (sto.lore.kernel.org [172.232.135.74])
	by mail.lfdr.de (Postfix) with ESMTPS id 44C6322FEA5
	for <lists+linux-tegra@lfdr.de>; Sun, 08 Mar 2026 12:56:32 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sto.lore.kernel.org (Postfix) with ESMTP id 8A592307CC42
	for <lists+linux-tegra@lfdr.de>; Sun,  8 Mar 2026 11:49:28 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 2715E39282A;
...
X-Spamd-Result: default: False [2.84 / 15.00];
	...
	MIME_TRACE(0.00)[0:+];
	TAGGED_FROM(0.00)[bounces-12635-lists,linux-tegra=lfdr.de];
	RCVD_TLS_LAST(0.00)[];
	...
	FROM_NO_DN(0.00)[];
	DBL_BLOCKED_OPENRESOLVER(0.00)[davemloft.net:email,nxp.com:dkim,nxp.com:email,nxp.com:mid,sto.lore.kernel.org:rdns,sto.lore.kernel.org:helo,renesas.com:email,glider.be:email,armlinux.org.uk:email]
