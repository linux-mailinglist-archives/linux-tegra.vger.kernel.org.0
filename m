Return-Path: <linux-tegra+bounces-7718-lists+linux-tegra=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-tegra@lfdr.de
Delivered-To: lists+linux-tegra@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id A1D3FAF7F2D
	for <lists+linux-tegra@lfdr.de>; Thu,  3 Jul 2025 19:40:01 +0200 (CEST)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id C4FD2583E85
	for <lists+linux-tegra@lfdr.de>; Thu,  3 Jul 2025 17:40:01 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 002262F2347;
	Thu,  3 Jul 2025 17:39:57 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="fWuu6aAV"
X-Original-To: linux-tegra@vger.kernel.org
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 8DE05254B09
	for <linux-tegra@vger.kernel.org>; Thu,  3 Jul 2025 17:39:54 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.129.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1751564397; cv=none; b=cgoGg2Fq0bgnZtJsfziCzSauuiQdhMygd2HEXhECOerilHFe0r9U+ycjJOSyM+FrN44H0Tg97tySZV+sL4QKfjH0fWSMHDlFTYhuJmlg94Mh9xFu5OzNJnYrywySICj9dgByXK0Q8n834R3j94kRVpZf9W6KiJ92DVPgP/Qoo98=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1751564397; c=relaxed/simple;
	bh=LJrOY8iyNx7ebPgpOEUTtDRKiIOByh1ZuSMBS1XUGkI=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=ATJU0gnEjXNYwAPuASkoiUvknQMR+rcLWBCSKcmCUZO5z45chQrRfm03p8b54dN9kSo+B97IbiNUeQ/k9227AE1RjdxzwRifYQtEKdhObVC0OyG53qqwlSB0APrjkhFOg1qJFoZcJkmbIYUaOoZ0G6xb0JDWjFGHAYSZsKB3nq4=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=fWuu6aAV; arc=none smtp.client-ip=170.10.129.124
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1751564393;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=SLZYMAMnvdJXcm+be13+1Uu5xt2dhbKp+QVkop+i5OU=;
	b=fWuu6aAV7uRR9gMo7wWauUh9seDouWGPD3DmQOgNYVO8FGwUkffkW2FudEXMi0xvmwGfwx
	JHtE03TPPMqOABNhvH5mW0ZNK+TF1HAchczUp9okBeVgU04CyuB/ZLtUM+M+yyRSHCdoTz
	UC37XJdv8FWbdsktLCDlI2SfCHHvMmo=
Received: from mx-prod-mc-06.mail-002.prod.us-west-2.aws.redhat.com
 (ec2-35-165-154-97.us-west-2.compute.amazonaws.com [35.165.154.97]) by
 relay.mimecast.com with ESMTP with STARTTLS (version=TLSv1.3,
 cipher=TLS_AES_256_GCM_SHA384) id us-mta-209-JvV5Khj8Nima0Mb-T50azA-1; Thu,
 03 Jul 2025 13:39:46 -0400
X-MC-Unique: JvV5Khj8Nima0Mb-T50azA-1
X-Mimecast-MFC-AGG-ID: JvV5Khj8Nima0Mb-T50azA_1751564383
Received: from mx-prod-int-02.mail-002.prod.us-west-2.aws.redhat.com (mx-prod-int-02.mail-002.prod.us-west-2.aws.redhat.com [10.30.177.15])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
	(No client certificate requested)
	by mx-prod-mc-06.mail-002.prod.us-west-2.aws.redhat.com (Postfix) with ESMTPS id 122F6180028B;
	Thu,  3 Jul 2025 17:39:43 +0000 (UTC)
Received: from thuth-p1g4.redhat.com (unknown [10.44.32.252])
	by mx-prod-int-02.mail-002.prod.us-west-2.aws.redhat.com (Postfix) with ESMTP id 1EE691956087;
...
Subject: [PATCH v2 2/2] arm: Replace __ASSEMBLY__ with __ASSEMBLER__ in non-uapi headers
Date: Thu,  3 Jul 2025 19:38:59 +0200
Message-ID: <20250703173859.246664-3-thuth@redhat.com>
...
__ASSEMBLER__  instead. So let's standardize on the __ASSEMBLER__
...
index 4e7226ad02ec4..b1df6e02d273c 100644
...
+#ifndef __ASSEMBLER__
 ...
 #include <asm/cacheflush.h>
@@ -19,6 +19,6 @@ void __arch_sync_vdso_time_data(struct vdso_time_data *vdata)
