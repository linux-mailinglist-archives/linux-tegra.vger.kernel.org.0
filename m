...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 7F3E44AF1C
	for <lists+linux-tegra@lfdr.de>; Wed, 19 Jun 2019 02:39:56 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726238AbfFSAjy (ORCPT <rfc822;lists+linux-tegra@lfdr.de>);
        Tue, 18 Jun 2019 20:39:54 -0400
Received: from hqemgate16.nvidia.com ([216.228.121.65]:9129 "EHLO
        hqemgate16.nvidia.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726023AbfFSAjy (ORCPT
        <rfc822;linux-tegra@vger.kernel.org>);
        Tue, 18 Jun 2019 20:39:54 -0400
Received: from hqpgpgate102.nvidia.com (Not Verified[216.228.121.13]) by hqemgate16.nvidia.com (using TLS: TLSv1.2, DES-CBC3-SHA)
        id <B5d0984570000>; Tue, 18 Jun 2019 17:39:51 -0700
Received: from hqmail.nvidia.com ([172.20.161.6])
  by hqpgpgate102.nvidia.com (PGP Universal service);
  Tue, 18 Jun 2019 17:39:51 -0700
X-PGP-Universal: processed;
        by hqpgpgate102.nvidia.com on Tue, 18 Jun 2019 17:39:51 -0700
...
Received: from hqnvemgw01.nvidia.com (172.20.150.20) by HQMAIL108.nvidia.com
 ...
 Transport; Wed, 19 Jun 2019 00:39:50 +0000
Received: from skomatineni-linux.nvidia.com (Not Verified[10.2.168.217]) by hqnvemgw01.nvidia.com with Trustwave SEG (v7,5,8,10121)
        id <B5d0984560006>; Tue, 18 Jun 2019 17:39:51 -0700
From:   Sowjanya Komatineni <skomatineni@nvidia.com>
To:     <linux-tegra@vger.kernel.org>
CC:     <skomatineni@nvidia.com>
Subject: [PATCH V2] update to use bitmask instead of bit for parked configuration
Date:   Tue, 18 Jun 2019 17:39:46 -0700
Message-ID: <1560904786-10091-1-git-send-email-skomatineni@nvidia.com>
X-Mailer: git-send-email 2.7.4
X-NVConfidentiality: public
MIME-Version: 1.0
Content-Type: text/plain
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=nvidia.com; s=n1;
        t=1560904791; bh=Exc9yMu136r1J2jC/HSVGzMeeBP4EZv7XTEKH8Hhhu0=;
        h=X-PGP-Universal:From:To:CC:Subject:Date:Message-ID:X-Mailer:
         X-NVConfidentiality:MIME-Version:Content-Type;
        b=
...
---
 ...
 soc-to-kernel-pinctrl-driver.py |  20 ++-
...
index 65e4c604f1c9..b562b7523d56 100755
...
+    print('prk_mask, ', end='')
 ...
 if soc.soc_drvgroups_have_drvtype:
     print(', drvtype', end='')
@@ -571,6 +580,11 @@ for drvgroup in f():
