Return-Path: <linux-tegra+bounces-13660-lists+linux-tegra=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-tegra@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id gC+3FtPy12n6UwgAu9opvQ
	(envelope-from <linux-tegra+bounces-13660-lists+linux-tegra=lfdr.de@vger.kernel.org>)
	for <lists+linux-tegra@lfdr.de>; Thu, 09 Apr 2026 20:41:23 +0200
X-Original-To: lists+linux-tegra@lfdr.de
Received: from sin.lore.kernel.org (sin.lore.kernel.org [104.64.211.4])
	by mail.lfdr.de (Postfix) with ESMTPS id BCA923CEC90
	for <lists+linux-tegra@lfdr.de>; Thu, 09 Apr 2026 20:41:20 +0200 (CEST)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sin.lore.kernel.org (Postfix) with ESMTP id 3767C3023C94
	for <lists+linux-tegra@lfdr.de>; Thu,  9 Apr 2026 18:40:48 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 579653E3177;
	Thu,  9 Apr 2026 18:40:37 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="EHh+d0vY"
X-Original-To: linux-tegra@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id B71473128D4;
	Thu,  9 Apr 2026 18:40:36 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1775760037; cv=none; b=szzPn3ae4K+j6G8n5Z+gPL08VMKU7M1U7ak1pjkFg7ZhQUo5TpC9Yaa7M1VbL6Nnvr/whljm3O524ZdBo2fKvQ1+H97ToonfeDha5Ce+wbh3lkOJ0cq40f0YXjm3BVKSIXuc5OWh7wAUp8ytBbSFyvHCLpPOm2412tthugn5Wwo=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1775760037; c=relaxed/simple;
	bh=AKGNMwtnTRMNgcUeNcCssUmtqgewy4Q3TCb0kOYnEr8=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type:
	 Content-Disposition:In-Reply-To; b=eretK6jSm/S0/vs2Ur26bdLCy5A31Stc4YmbSZM9FwMxGVugdsR7T7M9HzzFY51Z/kfpVAmILlFKstuvCkhoy367/Rn+QTFC1HJtP32q7F1grjk3nQgsoUsVnSGKTSJJt1zMCrLt18/LCBcmE+yY4iIb3K08Iz0UiSxpmAZ91uk=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=EHh+d0vY; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPSA id C0C8DC2BCAF;
	Thu,  9 Apr 2026 18:40:35 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1775760036;
	bh=AKGNMwtnTRMNgcUeNcCssUmtqgewy4Q3TCb0kOYnEr8=;
	h=Date:From:To:Cc:Subject:In-Reply-To:From;
	b=
Date: Thu, 9 Apr 2026 13:40:34 -0500
...
Message-ID: <20260409184034.GA508609@bhelgaas>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="PgwKfkXnSb5DIoEO"
Content-Disposition: inline
Content-Transfer-Encoding: 8bit
In-Reply-To: <bb6583dd-7a30-4601-88b9-041ae3615860@nvidia.com>
X-Spamd-Result: default: False [1.44 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	TAGGED_FROM(0.00)[bounces-13660-lists,linux-tegra=lfdr.de];
	RCVD_TLS_LAST(0.00)[];
	FROM_HAS_DN(0.00)[];
...
# Linux/x86 7.0.0-rc1 Kernel Configuration
#
...
# CONFIG_MTD_NAND_LOONGSON is not set
...
# CONFIG_DWMAC_EIC7700 is not set
...
# CONFIG_SPI_NXP_XSPI is not set
...
# CONFIG_BATTERY_HUAWEI_GAOKUN is not set
# CONFIG_BATTERY_LEGO_EV3 is not set
# CONFIG_BATTERY_LENOVO_YOGA_C630 is not set
...
# CONFIG_VIDEO_OS05B10 is not set
...
# CONFIG_VIDEO_S5K3M5 is not set
...
# Sophgo
#
# CONFIG_SND_SOC_CV1800B_TDM is not set
# CONFIG_SND_SOC_CV1800B_ADC_CODEC is not set
# CONFIG_SND_SOC_CV1800B_DAC_CODEC is not set
# end of Sophgo

#
# SpacemiT
#
# CONFIG_SND_SOC_K1_I2S is not set
# end of SpacemiT
...
# CONFIG_UCSI_HUAWEI_GAOKUN is not set
...
CONFIG_COMMON_CLK_MT8196=y
CONFIG_COMMON_CLK_MT8196_IMP_IIC_WRAP=y
CONFIG_COMMON_CLK_MT8196_MCUSYS=y
CONFIG_COMMON_CLK_MT8196_MDPSYS=y
CONFIG_COMMON_CLK_MT8196_MFGCFG=m
CONFIG_COMMON_CLK_MT8196_MMSYS=m
CONFIG_COMMON_CLK_MT8196_PEXTPSYS=y
CONFIG_COMMON_CLK_MT8196_UFSSYS=y
...
# CONFIG_CLK_KAANAPALI_CAMCC is not set
# CONFIG_CLK_KAANAPALI_DISPCC is not set
CONFIG_CLK_KAANAPALI_GCC=y
# CONFIG_CLK_KAANAPALI_GPUCC is not set
CONFIG_CLK_KAANAPALI_TCSRCC=m
# CONFIG_CLK_KAANAPALI_VIDEOCC is not set
...
# CONFIG_SM_CAMCC_8750 is not set
