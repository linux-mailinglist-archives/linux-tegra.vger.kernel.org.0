...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 0C06560C6F1
	for <lists+linux-tegra@lfdr.de>; Tue, 25 Oct 2022 10:52:42 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231882AbiJYIwk (ORCPT <rfc822;lists+linux-tegra@lfdr.de>);
        Tue, 25 Oct 2022 04:52:40 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:35208 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232053AbiJYIwS (ORCPT
        <rfc822;linux-tegra@vger.kernel.org>);
        Tue, 25 Oct 2022 04:52:18 -0400
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 67561111BA7;
        Tue, 25 Oct 2022 01:52:09 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1666687929; x=1698223929;
  h=date:from:to:cc:subject:message-id:references:
   mime-version:in-reply-to;
  bh=OuDsgld/clYfofGObi47LnN6bpimNTBJlfp6/egsiSs=;
  b=W+l7QtZh41/BTjYxO8sk8cO/LEdvNogMEg6GGairCt4AMxJwhIPyNf3F
   FU8ABrmq9GS34efNhM6py7+/E/tUbRpmRwQjwJtFhLtzxtp1UM1BfibPm
   nYNbny4Q79Zy5hfswhfNiTMuVti59pJO7CrVl9471P9OLjIwBnN1cNrZd
   0nNaRsheLQ1P342MO6SJtZbuUe+ydZyuZn6kFnyPe+Ft2sS0BiMDK3stz
   yJckDyxz6B1Hg8Xpp0FRaVQ7aV7XSh4yDr6uQr/T2a61u1RzftCovs4aO
   vTRdWP+Bmv9pRCVdcJzln7V0HRp8go+Wd4Iak5z7HKrhADrS0KnDGwrHR
   Q==;
X-IronPort-AV: E=McAfee;i="6500,9779,10510"; a="295028044"
X-IronPort-AV: E=Sophos;i="5.95,211,1661842800"; 
   d="scan'208";a="295028044"
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
  by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 25 Oct 2022 01:52:08 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10510"; a="774121824"
X-IronPort-AV: E=Sophos;i="5.95,211,1661842800"; 
   d="scan'208";a="774121824"
Received: from lkp-server02.sh.intel.com (HELO b6d29c1a0365) ([10.239.97.151])
  by fmsmga001.fm.intel.com with ESMTP; 25 Oct 2022 01:52:05 -0700
Received: from kbuild by b6d29c1a0365 with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1onFfI-00066Q-1Z;
        Tue, 25 Oct 2022 08:52:04 +0000
Date:   Tue, 25 Oct 2022 16:51:40 +0800
From:   kernel test robot <lkp@intel.com>
To:     Peter De Schrijver <pdeschrijver@nvidia.com>, treding@nvidia.com,
        linux-tegra@vger.kernel.org
Cc:     kbuild-all@lists.01.org, linux-clk@vger.kernel.org,
        Peter De Schrijver <pdeschrijver@nvidia.com>
Subject: Re: [PATCH 2/2] clk: tegra: support BPMP-FW ABI deny flags
Message-ID: <202210251611.UnGuUf74-lkp@intel.com>
References: <20221024121439.3381239-2-pdeschrijver@nvidia.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="xDiqXERBTuJRC3uO"
Content-Disposition: inline
In-Reply-To: <20221024121439.3381239-2-pdeschrijver@nvidia.com>
...
[also build test WARNING on clk/clk-next tegra-drm/drm/tegra/for-next linus/master v6.1-rc2 next-20221024]
[If your patch is applied to the wrong git tree, kindly drop us a note.
And when submitting patch, we suggest to use '--base' as documented in
https://git-scm.com/docs/git-format-patch#_base_tree_information]

url:    https://github.com/intel-lab-lkp/linux/commits/Peter-De-Schrijver/firmware-tegra-Update-BPMP-ABI/20221024-221024
base:   https://git.kernel.org/pub/scm/linux/kernel/git/tegra/linux.git for-next
patch link:    https://lore.kernel.org/r/20221024121439.3381239-2-pdeschrijver%40nvidia.com
patch subject: [PATCH 2/2] clk: tegra: support BPMP-FW ABI deny flags
config: arm-allyesconfig
compiler: arm-linux-gnueabi-gcc (GCC) 12.1.0
reproduce (this is a W=1 build):
        wget https://raw.githubusercontent.com/intel/lkp-tests/master/sbin/make.cross -O ~/bin/make.cross
        chmod +x ~/bin/make.cross
        # https://github.com/intel-lab-lkp/linux/commit/04398a53ba8482fad636f27694a2fa94e8a89b68
        git remote add linux-review https://github.com/intel-lab-lkp/linux
        git fetch --no-tags linux-review Peter-De-Schrijver/firmware-tegra-Update-BPMP-ABI/20221024-221024
        git checkout 04398a53ba8482fad636f27694a2fa94e8a89b68
        # save the config file
        mkdir build_dir && cp config build_dir/.config
        COMPILER_INSTALL_PATH=$HOME/0day COMPILER=gcc-12.1.0 make.cross W=1 O=build_dir ARCH=arm SHELL=/bin/bash drivers/clk/tegra/
...
All warnings (new ones prefixed by >>):
   ...
   In file included from include/linux/kernel.h:29,
                    ...
                    from drivers/clk/tegra/clk-bpmp.c:6:
   drivers/clk/tegra/clk-bpmp.c: In function 'tegra_bpmp_clk_register':
>> include/linux/printk.h:397:76: warning: pointer/integer type mismatch in conditional expression
     397 |                                 .fmt = __builtin_constant_p(_fmt) ? (_fmt) : NULL, \
         |                                                                            ^
   include/linux/printk.h:431:9: note: in expansion of macro '__printk_index_emit'
   ...
   include/linux/dev_printk.h:109:17: note: in expansion of macro 'dev_printk_index_emit'
     109 |                 dev_printk_index_emit(level, fmt);                      \
         |                 ^~~~~~~~~~~~~~~~~~~~~
   include/linux/dev_printk.h:146:9: note: in expansion of macro 'dev_printk_index_wrap'
     146 |         dev_printk_index_wrap(_dev_warn, KERN_WARNING, dev, dev_fmt(fmt), ##__VA_ARGS__)
         |         ^~~~~~~~~~~~~~~~~~~~~
   drivers/clk/tegra/clk-bpmp.c:531:17: note: in expansion of macro 'dev_warn'
     531 |                 dev_warn(bpmp->dev,
         |                 ^~~~~~~~
   In file included from include/linux/device.h:15,
                    from drivers/clk/tegra/clk-bpmp.c:7:
>> drivers/clk/tegra/clk-bpmp.c:532:76: warning: passing argument 2 of '_dev_warn' makes pointer from integer without a cast [-Wint-conversion]
     532 |                         (info->flags & BPMP_CLK_RATE_PARENT_CHANGE_DENIED) == 0);
         |                         ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~^~~~
         |                                                                            |
         |                                                                            int
   ...
   drivers/clk/tegra/clk-bpmp.c:531:17: note: in expansion of macro 'dev_warn'
     531 |                 dev_warn(bpmp->dev,
         |                 ^~~~~~~~
   include/linux/dev_printk.h:52:54: note: expected 'const char *' but argument is of type 'int'
      52 | void _dev_warn(const struct device *dev, const char *fmt, ...);
         |                                          ~~~~~~~~~~~~^~~


vim +/_dev_warn +532 drivers/clk/tegra/clk-bpmp.c

   499	
   500	static struct tegra_bpmp_clk *
   501	tegra_bpmp_clk_register(struct tegra_bpmp *bpmp,
   ...
   531			dev_warn(bpmp->dev,
 > 532				(info->flags & BPMP_CLK_RATE_PARENT_CHANGE_DENIED) == 0);
   533			if (info->flags & TEGRA_BPMP_CLK_HAS_MUX)
   534				init.ops = &tegra_bpmp_clk_mux_read_only_ops;
   535			else
   536				init.ops = &tegra_bpmp_clk_read_only_ops;
   537		} else if (info->flags & BPMP_CLK_RATE_PARENT_CHANGE_DENIED) {
   538			if (info->flags & TEGRA_BPMP_CLK_HAS_MUX)
   539				init.ops = &tegra_bpmp_clk_gate_mux_read_only_ops;
   540			else
   541				init.ops = &tegra_bpmp_clk_gate_ops;
   542		} else if (info->flags & TEGRA_BPMP_CLK_HAS_MUX) {
   543			if (info->flags & TEGRA_BPMP_CLK_HAS_SET_RATE)
   544				init.ops = &tegra_bpmp_clk_mux_rate_ops;
   545			else
   546				init.ops = &tegra_bpmp_clk_mux_ops;
   547		} else {
   548			if (info->flags & TEGRA_BPMP_CLK_HAS_SET_RATE)
   549				init.ops = &tegra_bpmp_clk_rate_ops;
   550			else
   551				init.ops = &tegra_bpmp_clk_gate_ops;
   552		}
   553	
   554		init.num_parents = info->num_parents;
   555	
   556		parents = kcalloc(info->num_parents, sizeof(*parents), GFP_KERNEL);
   557		if (!parents)
   558			return ERR_PTR(-ENOMEM);
   559	
   560		for (i = 0; i < info->num_parents; i++) {
   561			const struct tegra_bpmp_clk_info *parent;
   562	
   563			/* keep a private copy of the ID to parent index map */
   564			clk->parents[i] = info->parents[i];
   565	
   566			parent = tegra_bpmp_clk_find(clocks, num_clocks,
   567						     info->parents[i]);
   568			if (!parent) {
   569				dev_err(bpmp->dev, "no parent %u found for %u\n",
   570					info->parents[i], info->id);
   571				continue;
   572			}
   573	
   574			parents[i] = parent->name;
   575		}
   576	
   577		init.parent_names = parents;
   578	
   579		err = devm_clk_hw_register(bpmp->dev, &clk->hw);
   580	
   581		kfree(parents);
   582	
   583		if (err < 0)
