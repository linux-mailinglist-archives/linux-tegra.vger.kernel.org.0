Return-Path: <linux-tegra+bounces-280-lists+linux-tegra=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-tegra@lfdr.de
Delivered-To: lists+linux-tegra@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 764AC811105
	for <lists+linux-tegra@lfdr.de>; Wed, 13 Dec 2023 13:22:05 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 7F5DE1C20FBA
	for <lists+linux-tegra@lfdr.de>; Wed, 13 Dec 2023 12:22:04 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 4849D28E1D;
	Wed, 13 Dec 2023 12:21:58 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=Nvidia.com header.i=@Nvidia.com header.b="GTM4FAkt"
...
Received: from NAM02-SN1-obe.outbound.protection.outlook.com (mail-sn1nam02on2041.outbound.protection.outlook.com [40.107.96.41])
	by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 6D49F197;
	Wed, 13 Dec 2023 04:21:45 -0800 (PST)
ARC-Seal: i=1; a=rsa-sha256; s=arcselector9901; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com;
 s=arcselector9901;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-AntiSpam-MessageData-ChunkCount:X-MS-Exchange-AntiSpam-MessageData-0:X-MS-Exchange-AntiSpam-MessageData-1;
 bh=waD9XjABPzI3FDIaHLNrJGjuALu6chZM7t9gJjU7o80=;
 b=
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=Nvidia.com;
 ...
 bh=waD9XjABPzI3FDIaHLNrJGjuALu6chZM7t9gJjU7o80=;
 b=
...
Received: from CY4PEPF0000EE38.namprd03.prod.outlook.com
 (2603:10b6:930:4b:cafe::3d) by CY8PR10CA0047.outlook.office365.com
 (2603:10b6:930:4b::25) with Microsoft SMTP Server (version=TLS1_2,
 cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id 15.20.7091.26 via Frontend
 Transport; Wed, 13 Dec 2023 12:21:39 +0000
...
Received: from mail.nvidia.com (216.228.118.233) by
 ...
 15.20.7091.26 via Frontend Transport; Wed, 13 Dec 2023 12:21:37 +0000
...
Received: from drhqmail202.nvidia.com (10.126.190.181) by
 ...
 15.2.986.41; Wed, 13 Dec 2023 04:21:28 -0800
Received: from BUILDSERVER-IO-L4T.nvidia.com (10.127.8.14) by mail.nvidia.com
 (10.126.190.181) with Microsoft SMTP Server id 15.2.986.41 via Frontend
 Transport; Wed, 13 Dec 2023 04:21:26 -0800
...
Subject: [PATCH 3/5] crypto: tegra: Add Tegra Security Engine driver
Date: Wed, 13 Dec 2023 17:50:28 +0530
Message-ID: <20231213122030.11734-4-akhilrajeev@nvidia.com>
...
X-MS-TrafficTypeDiagnostic: CY4PEPF0000EE38:EE_|PH7PR12MB8593:EE_
X-MS-Office365-Filtering-Correlation-Id: dbe4f121-bbb0-4bb6-4bc6-08dbfbd60def
X-MS-Exchange-SenderADCheck: 1
X-MS-Exchange-AntiSpam-Relay: 0
X-Microsoft-Antispam: BCL:0;
X-Microsoft-Antispam-Message-Info:
	
X-Forefront-Antispam-Report:
	CIP:216.228.118.233;CTRY:US;LANG:en;SCL:1;SRV:;IPV:NLI;SFV:NSPM;H:mail.nvidia.com;PTR:dc7edge2.nvidia.com;CAT:NONE;SFS:(13230031)(4636009)(376002)(39860400002)(346002)(136003)(396003)(230922051799003)(64100799003)(82310400011)(186009)(451199024)(1800799012)(36840700001)(46966006)(40470700004)(40480700001)(7636003)(5660300002)(8936002)(4326008)(41300700001)(8676002)(70206006)(40460700003)(70586007)(86362001)(316002)(110136005)(36860700001)(36756003)(356005)(15650500001)(30864003)(47076005)(82740400003)(2906002)(26005)(83380400001)(426003)(336012)(1076003)(43170500006)(107886003)(2616005)(478600001)(7696005)(579004)(559001)(357404004);DIR:OUT;SFP:1101;
X-OriginatorOrg: Nvidia.com
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 13 Dec 2023 12:21:37.7322
 (UTC)
X-MS-Exchange-CrossTenant-Network-Message-Id: dbe4f121-bbb0-4bb6-4bc6-08dbfbd60def
...
---
 ...
 9 files changed, 4212 insertions(+)
...
index 902708b4530d..0e04beb0c55b 100644
--- a/MAINTAINERS
+++ b/MAINTAINERS
@@ -21388,6 +21388,11 @@ M:	Prashant Gaikwad <pgaikwad@nvidia.com>
 S:	Supported
 F:	drivers/clk/tegra/
...
new file mode 100644
index 000000000000..65420cce2e74
--- /dev/null
...
+	for (i = 0; i < CMAC_RESULT_REG_COUNT; i++)
+		rctx->result[i] = se_readl(ctx->se, ctx->se->hw->regs->result + (i * 4));
+
...
+	for (i = 0; i < CMAC_RESULT_REG_COUNT; i++)
+		se_writel(ctx->se, rctx->result[i], ctx->se->hw->regs->result + (i * 4));
+
+	return 0;
+}
+
...
new file mode 100644
index 000000000000..9cc3c9ea6aca
--- /dev/null
...
new file mode 100644
index 000000000000..57754519b7c9
--- /dev/null
...
new file mode 100644
index 000000000000..0d3d1acfad2d
--- /dev/null
...
new file mode 100644
index 000000000000..9791563ee1c4
--- /dev/null
