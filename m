Return-Path: <linux-tegra+bounces-12960-lists+linux-tegra=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-tegra@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id mOvdNFl6vGkFzQIAu9opvQ
	(envelope-from <linux-tegra+bounces-12960-lists+linux-tegra=lfdr.de@vger.kernel.org>)
	for <lists+linux-tegra@lfdr.de>; Thu, 19 Mar 2026 23:36:09 +0100
X-Original-To: lists+linux-tegra@lfdr.de
Received: from sto.lore.kernel.org (sto.lore.kernel.org [IPv6:2600:3c09:e001:a7::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id B3F5A2D3366
	for <lists+linux-tegra@lfdr.de>; Thu, 19 Mar 2026 23:36:09 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sto.lore.kernel.org (Postfix) with ESMTP id 9C67D303871C
	for <lists+linux-tegra@lfdr.de>; Thu, 19 Mar 2026 22:34:59 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 26BC641160D;
...
X-Spamd-Result: default: False [2.84 / 15.00];
	...
	MIME_TRACE(0.00)[0:+];
	TAGGED_FROM(0.00)[bounces-12960-lists,linux-tegra=lfdr.de];
	...
	TAGGED_RCPT(0.00)[linux-tegra,linaro];
	NEURAL_HAM(-0.00)[-0.910];
	ASN(0.00)[asn:63949, ipnet:2600:3c09::/32, country:SG];
	DBL_BLOCKED_OPENRESOLVER(0.00)[intel.com:email,nvidia.com:email,linuxfoundation.org:email,args.np:url,sto.lore.kernel.org:helo,sto.lore.kernel.org:rdns,nxp.com:dkim,nxp.com:email,nxp.com:mid]
X-Rspamd-Queue-Id: B3F5A2D3366
