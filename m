Return-Path: <linux-tegra+bounces-534-lists+linux-tegra=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-tegra@lfdr.de
Delivered-To: lists+linux-tegra@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id E2D5E83A454
	for <lists+linux-tegra@lfdr.de>; Wed, 24 Jan 2024 09:40:36 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 10B891F2860E
	for <lists+linux-tegra@lfdr.de>; Wed, 24 Jan 2024 08:40:36 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 3DEA71775B;
	Wed, 24 Jan 2024 08:40:23 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=Nvidia.com header.i=@Nvidia.com header.b="AkKavsi4"
X-Original-To: linux-tegra@vger.kernel.org
Received: from NAM10-DM6-obe.outbound.protection.outlook.com (mail-dm6nam10on2042.outbound.protection.outlook.com [40.107.93.42])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 8F5AE179A6;
	Wed, 24 Jan 2024 08:40:17 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=fail smtp.client-ip=40.107.93.42
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1706085623; cv=fail; b=nUxBptEmHF7lDW8YINggCU2gha+UyDkTl/Ms/z7HLRxwpZfsiahd9v//KDCP3UNz9ozpwKZ6vSsaIwLej1eRKs/Bjc48MZIX9DWMt86ZdsHCl33iAg7Sk99nd9ZI9Vep8GuBvqCZYTuYFvQTrYKtH3IVSPYCBtfg5ShF0X8ZBqI=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1706085623; c=relaxed/simple;
	bh=v8Uis3A1tsMT15IGxOniYo8bK3E17QLHPb4Np0EvKP0=;
	h=From:To:CC:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version:Content-Type; b=k1LSRwlLrd31KCSPBcluC7JkRmTFCRor0vC1dukkLxpkoOBNJbDOJWpwfoYdFlfuZ6AQF5Wf2sjj47URYTaHAS4eYX4iuHq94siiXaaULOuAOGJVM5dOt6Ou2NhrJEE7hoHWm0e6BAkLj89hMMbn9dhoi1C7BMW1Bdk+SLMkETY=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=nvidia.com; spf=fail smtp.mailfrom=nvidia.com; dkim=pass (2048-bit key) header.d=Nvidia.com header.i=@Nvidia.com header.b=AkKavsi4; arc=fail smtp.client-ip=40.107.93.42
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=nvidia.com
Authentication-Results: smtp.subspace.kernel.org; spf=fail smtp.mailfrom=nvidia.com
ARC-Seal: i=1; a=rsa-sha256; s=arcselector9901; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com;
 s=arcselector9901;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-AntiSpam-MessageData-ChunkCount:X-MS-Exchange-AntiSpam-MessageData-0:X-MS-Exchange-AntiSpam-MessageData-1;
 bh=ZT7kpNow2VX0tLTcwWu1FfTDUFgmov/BhcCHo8f9T8w=;
 b=
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=Nvidia.com;
 ...
 bh=ZT7kpNow2VX0tLTcwWu1FfTDUFgmov/BhcCHo8f9T8w=;
 b=
...
Received: from DS2PEPF0000343B.namprd02.prod.outlook.com
 (2603:10b6:5:3b4:cafe::aa) by DS7PR03CA0135.outlook.office365.com
 (2603:10b6:5:3b4::20) with Microsoft SMTP Server (version=TLS1_2,
 cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id 15.20.7228.22 via Frontend
 Transport; Wed, 24 Jan 2024 08:40:11 +0000
...
Received: from mail.nvidia.com (216.228.117.161) by
 ...
 15.20.7202.16 via Frontend Transport; Wed, 24 Jan 2024 08:40:10 +0000
...
Received: from BUILDSERVER-IO-L4T.nvidia.com (10.127.8.14) by mail.nvidia.com
 ...
 Transport; Wed, 24 Jan 2024 00:39:55 -0800
...
Subject: [PATCH v4 3/5] crypto: tegra: Add Tegra Security Engine driver
Date: Wed, 24 Jan 2024 14:08:44 +0530
Message-ID: <20240124083846.46487-4-akhilrajeev@nvidia.com>
...
X-MS-TrafficTypeDiagnostic: DS2PEPF0000343B:EE_|MW4PR12MB7264:EE_
X-MS-Office365-Filtering-Correlation-Id: eaf7714f-1413-4f56-d642-08dc1cb8137d
X-MS-Exchange-SenderADCheck: 1
X-MS-Exchange-AntiSpam-Relay: 0
X-Microsoft-Antispam: BCL:0;
X-Microsoft-Antispam-Message-Info:
	
X-Forefront-Antispam-Report:
	CIP:216.228.117.161;CTRY:US;LANG:en;SCL:1;SRV:;IPV:NLI;SFV:NSPM;H:mail.nvidia.com;PTR:dc6edge2.nvidia.com;CAT:NONE;SFS:(13230031)(4636009)(396003)(39860400002)(376002)(346002)(136003)(230922051799003)(451199024)(1800799012)(82310400011)(64100799003)(186009)(36840700001)(46966006)(40470700004)(36860700001)(426003)(1076003)(26005)(6666004)(107886003)(7696005)(336012)(478600001)(43170500006)(110136005)(316002)(47076005)(15650500001)(5660300002)(30864003)(7416002)(2906002)(41300700001)(83380400001)(36756003)(70586007)(8676002)(70206006)(4326008)(8936002)(921011)(86362001)(82740400003)(7636003)(356005)(2616005)(40480700001)(40460700003)(559001)(579004)(357404004);DIR:OUT;SFP:1101;
X-OriginatorOrg: Nvidia.com
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 24 Jan 2024 08:40:10.4779
 (UTC)
X-MS-Exchange-CrossTenant-Network-Message-Id: eaf7714f-1413-4f56-d642-08dc1cb8137d
...
---
 ...
 9 files changed, 4141 insertions(+)
...
index 7fe27cd60e1b..a7a3e7e7cb98 100644
--- a/MAINTAINERS
+++ b/MAINTAINERS
@@ -21462,6 +21462,11 @@ M:	Prashant Gaikwad <pgaikwad@nvidia.com>
 S:	Supported
 F:	drivers/clk/tegra/
...
index 79c3bb9c99c3..9f4e535f4434 100644
--- a/drivers/crypto/Kconfig
+++ b/drivers/crypto/Kconfig
@@ -659,6 +659,14 @@ config CRYPTO_DEV_ROCKCHIP_DEBUG
...
index d859d6a5f3a4..5ffc8ba583d4 100644
...
new file mode 100644
index 000000000000..fb65b39583e3
--- /dev/null
...
+	cpuvaddr[i++] = (rctx->len / AES_BLOCK_SIZE) - 1;
...
+
+	rctx->encrypt = true;
+	rctx->config = tegra234_aes_cfg(ctx->alg, true);
+	rctx->crypto_config = tegra234_aes_crypto_cfg(ctx->alg, true);
...
+
+	rctx->encrypt = false;
+	rctx->config = tegra234_aes_cfg(ctx->alg, false);
+	rctx->crypto_config = tegra234_aes_crypto_cfg(ctx->alg, false);
+	rctx->crypto_config |= SE_AES_KEY_INDEX(ctx->key1_id);
+
+	if (ctx->key2_id)
+		rctx->crypto_config |= SE_AES_KEY2_INDEX(ctx->key2_id);
...
+	int i;
+
+	/* Copy all intermediate results */
+	for (i = 0; i < CMAC_RESULT_REG_COUNT; i++)
+		rctx->result[i] = readl(ctx->se->base + ctx->se->hw->regs->result + (i * 4));
+
...
new file mode 100644
index 000000000000..386cfcf9e4b6
--- /dev/null
...
new file mode 100644
index 000000000000..2737555b4a09
--- /dev/null
